...
from .transform import image_transform_with_config, AugmentationCfg, PreprocessCfg, merge_preprocess_dict, merge_preprocess_kwargs
...
def create_model_and_transforms(
    ...
    preprocess_train = image_transform_with_config(
        pp_cfg,
        is_train=True,
        aug_cfg=aug_cfg,
    )
    preprocess_val = image_transform_with_config(
        pp_cfg,
        is_train=False,
    )
...
def create_model_from_pretrained(
    ...
    preprocess = image_transform_with_config(
